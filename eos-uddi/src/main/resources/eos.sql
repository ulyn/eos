...
CREATE TABLE `T_CONFIG_CHILD_APP` (
  ...
  `SVN` varchar(255) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `T_DB_CHANGE` (
  ...
  `CHANGE_LOG` text COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `T_METHOD` (
  ...
  `VERSION` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `MOCK_RESULT` text COLLATE utf8_bin DEFAULT NULL,
...
ALTER TABLE `T_SERVICE_VERSION`
ADD COLUMN `VERSION_NUM` varchar(255) NULL AFTER `SERVICE_ID`;
